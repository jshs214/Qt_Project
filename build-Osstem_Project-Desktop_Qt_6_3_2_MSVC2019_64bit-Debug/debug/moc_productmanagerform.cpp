...
#include <memory>
#include "../../Osstem_Project/productmanagerform.h"
...
static const qt_meta_stringdata_ProductManagerForm_t qt_meta_stringdata_ProductManagerForm = {
    {
        ...
        QT_MOC_LITERAL(66, 24),  // "on_addPushButton_clicked"
        QT_MOC_LITERAL(91, 27),  // "on_modifyPushButton_clicked"
        QT_MOC_LITERAL(119, 27),  // "on_searchPushButton_clicked"
        QT_MOC_LITERAL(147, 26),  // "on_statePushButton_clicked"
        QT_MOC_LITERAL(174, 15),  // "showContextMenu"
        QT_MOC_LITERAL(190, 10),  // "removeItem"
        QT_MOC_LITERAL(201, 25),  // "on_treeWidget_itemClicked"
        QT_MOC_LITERAL(227, 16),  // "QTreeWidgetItem*"
        QT_MOC_LITERAL(244, 4),  // "item"
        QT_MOC_LITERAL(249, 6),  // "column"
        QT_MOC_LITERAL(256, 18),  // "receiveProductName"
        QT_MOC_LITERAL(275, 15),  // "receiveAddStock"
        QT_MOC_LITERAL(291, 15),  // "receiveModStock"
        QT_MOC_LITERAL(307, 15),  // "receiveDelStock"
        QT_MOC_LITERAL(323, 17),  // "receiveProductKey"
        QT_MOC_LITERAL(341, 22)   // "on_clearbutton_clicked"
    },
    "ProductManagerForm",
    "productDataSent",
    "",
...
static const uint qt_meta_data_ProductManagerForm[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      11,    2,  118,    2, 0x08,   12 /* Private */,
      15,    1,  123,    2, 0x08,   15 /* Private */,
      16,    2,  126,    2, 0x08,   17 /* Private */,
      17,    3,  131,    2, 0x08,   20 /* Private */,
      18,    2,  138,    2, 0x08,   24 /* Private */,
      19,    1,  143,    2, 0x08,   27 /* Private */,
      20,    0,  146,    2, 0x08,   29 /* Private */,
...
void ProductManagerForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_modifyPushButton_clicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ProductManagerForm::productDataSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ProductManagerForm::*)(ProductItem * );
            if (_t _q_method = &ProductManagerForm::clickProductSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
