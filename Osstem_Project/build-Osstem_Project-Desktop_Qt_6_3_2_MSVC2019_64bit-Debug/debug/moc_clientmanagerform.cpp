...
#include <memory>
#include "../../Osstem_Project/clientmanagerform.h"
...
static const qt_meta_stringdata_ClientManagerForm_t qt_meta_stringdata_ClientManagerForm = {
    {
        ...
        QT_MOC_LITERAL(62, 9),  // "addClient"
        QT_MOC_LITERAL(72, 9),  // "remClient"
        QT_MOC_LITERAL(82, 24),  // "on_addPushButton_clicked"
        QT_MOC_LITERAL(107, 27),  // "on_modifyPushButton_clicked"
        QT_MOC_LITERAL(135, 27),  // "on_searchPushButton_clicked"
        QT_MOC_LITERAL(163, 26),  // "on_statePushButton_clicked"
        QT_MOC_LITERAL(190, 15),  // "showContextMenu"
        QT_MOC_LITERAL(206, 10),  // "removeItem"
        QT_MOC_LITERAL(217, 31),  // "on_clientTreeWidget_itemClicked"
        QT_MOC_LITERAL(249, 16),  // "QTreeWidgetItem*"
        QT_MOC_LITERAL(266, 4),  // "item"
        QT_MOC_LITERAL(271, 6),  // "column"
        QT_MOC_LITERAL(278, 17),  // "receiveClientName"
        QT_MOC_LITERAL(296, 16),  // "receiveClientKey"
        QT_MOC_LITERAL(313, 22)   // "on_clearButton_clicked"
    },
    "ClientManagerForm",
    "clientDataSent",
    "",
...
static const uint qt_meta_data_ClientManagerForm[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       7,    0,  112,    2, 0x08,   10 /* Private */,
       8,    0,  113,    2, 0x08,   11 /* Private */,
       9,    0,  114,    2, 0x08,   12 /* Private */,
      10,    0,  115,    2, 0x08,   13 /* Private */,
      11,    1,  116,    2, 0x08,   14 /* Private */,
      12,    0,  119,    2, 0x08,   16 /* Private */,
      13,    2,  120,    2, 0x08,   17 /* Private */,
      17,    1,  125,    2, 0x08,   20 /* Private */,
      18,    1,  128,    2, 0x08,   22 /* Private */,
      19,    0,  131,    2, 0x08,   24 /* Private */,
...
void ClientManagerForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->addClient((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 3: _t->remClient((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        case 7: _t->on_statePushButton_clicked(); break;
        ...
        case 11: _t->receiveClientName((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 12: _t->receiveClientKey((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ClientManagerForm::clientDataSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ClientManagerForm::*)(ClientItem * );
            if (_t _q_method = &ClientManagerForm::clickClientSent; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ClientManagerForm::addClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ClientManagerForm::remClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void ClientManagerForm::addClient(int _t1, QString _t2)
{
...
// SIGNAL 3
void ClientManagerForm::remClient(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
